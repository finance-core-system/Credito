...
class CustomerServiceApplicationTests {
    ...
    private static final String KEY_ID = "customer-service-test-key";
    ...
    @Test
    void serviceTokenWithAllowedClientAndScopeCanAccessCustomersApi() throws Exception {
    ...
    @Test
    void serviceTokenWithUnexpectedClientIsRejected() throws Exception {
        HttpHeaders headers = new HttpHeaders();
        headers.setBearerAuth(serviceToken("batch-service", "customers.read"));
    ...
    static class TestEndpointConfiguration {
        ...
        @Bean
        CustomerProbeController customerProbeController() {
            return new CustomerProbeController();
        }
    }
