...
@SpringBootTest(
    ...
    properties = {
        ...
        "SYSTEM_REALM_ISSUER_URI=http://localhost:8085/realms/system-realm",
        "SYSTEM_REALM_JWK_SET_URI=http://localhost:8085/realms/system-realm/protocol/openid-connect/certs",
        "SYSTEM_REALM_INTERNAL_ISSUER_URI=http://keycloak:8080/realms/system-realm",
        "SYSTEM_REALM_INTERNAL_JWK_SET_URI=http://localhost:8085/realms/system-realm/protocol/openid-connect/certs",
        "MTLS_ENABLED=false",
        "MTLS_KEY_STORE=",
