...
@SpringBootTest(
    ...
    classes = {
        ...
        BatchServiceApplicationTests.TestEndpointConfiguration.class
    },
    properties = {
        "SERVER_PORT=0",
        "MTLS_ENABLED=false",
...
class BatchServiceApplicationTests {
    ...
    private static final String KEY_ID = "batch-service-test-key";
    ...
    @Test
    void serviceTokenWithAllowedClientAndScopeCanAccessBatchApi() throws Exception {
        HttpHeaders headers = new HttpHeaders();
        headers.setBearerAuth(serviceToken("gateway-service", "batch.run"));
    ...
    @Test
    void serviceTokenWithWrongClientIsRejected() throws Exception {
        HttpHeaders headers = new HttpHeaders();
        headers.setBearerAuth(serviceToken("batch-service", "batch.run"));
    ...
    static class TestEndpointConfiguration {
        ...
        @Bean
        BatchProbeController batchProbeController() {
            return new BatchProbeController();
        }
    }

    @RestController
    static class BatchProbeController {
