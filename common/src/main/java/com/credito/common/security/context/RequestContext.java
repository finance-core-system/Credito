...
/**
 * 요청 처리에 필요한 추적 및 클라이언트 요청 메타데이터를 담는 불변 컨텍스트입니다.
 *
 * <p>trace id, idempotency key, source IP, user agent, 요청 시각, 추가 속성을 하나로 묶어
 * 서비스 내부 흐름에서 동일한 요청 정보를 전달할 수 있게 합니다.</p>
 *
 * <p>주요 책임</p>
 * <ul>
 *     <li>요청 trace id 보관</li>
 *     <li>idempotency key 보관</li>
 *     <li>source IP와 user agent 보관</li>
 *     <li>요청 생성 시각 보관</li>
 *     <li>요청 부가 속성 보관</li>
 * </ul>
 */
